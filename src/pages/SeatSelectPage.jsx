...
const MOCK_SEATS = {
  ...
  R석: [
    { id: 7, row: 'C', num: '1', price: 100000, status: 'AVAILABLE' },
    { id: 8, row: 'C', num: '2', price: 100000, status: 'AVAILABLE' },
    { id: 9, row: 'C', num: '3', price: 100000, status: 'AVAILABLE' },
    { id: 10, row: 'D', num: '1', price: 100000, status: 'RESERVED' },
    { id: 11, row: 'D', num: '2', price: 100000, status: 'AVAILABLE' },
    { id: 12, row: 'D', num: '3', price: 100000, status: 'AVAILABLE' },
  ],
  S석: [
    { id: 13, row: 'E', num: '1', price: 80000, status: 'AVAILABLE' },
    { id: 14, row: 'E', num: '2', price: 80000, status: 'AVAILABLE' },
    { id: 15, row: 'E', num: '3', price: 80000, status: 'AVAILABLE' },
    { id: 16, row: 'F', num: '1', price: 80000, status: 'AVAILABLE' },
    { id: 17, row: 'F', num: '2', price: 80000, status: 'SOLD' },
    { id: 18, row: 'F', num: '3', price: 80000, status: 'AVAILABLE' },
  ],
}
